...
export const PROJECTS: Project[] = [
  {
    ...
    name: "Soho Jewels",
    description:
      "A luxury eCommerce platform for jewellery with Stripe payments, admin dashboard, customer reviews, and 2FA.",
  ...
  },
  {
    ...
    description:
      "Real-time bus tracking for passengers — view routes, select drop-off stops, and see live GPS bus locations updating every 10 seconds.",
  ...
  },
  {
    ...
    name: "TaskFlow",
    description:
      "A productivity web app with task management, time tracking, goal setting, team collaboration, and an analytics dashboard.",
